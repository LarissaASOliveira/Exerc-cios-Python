...
É esconder os detalhes internos de implementação e mostrar apenas o necessário.

A ideia é trabalhar no nível mais génerico e deixar que as classes mais específicas implementem os detalhes.
